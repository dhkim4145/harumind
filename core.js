...
core.showDailyLimitScreen = function() {
    ...
    const messages = [
        ...
        '오늘의 여운을 가만히 느껴보세요. 내일의 마음 조각은 제가 소중히 준비해둘게요.', // TODO: shorten later - too narrative
        '충분히 잘해주셨어요. 지금은 화면 밖의 소중한 일상으로 가볍게 돌아가셔도 좋아요.',
        '오늘 채운 온기가 밤새 당신을 포근하게 감싸주길 바라요. 내일 또 만나요.' // TODO: shorten later - too narrative
    ];
...
core.showCompletionModal = function(opts = {}) {
    ...
    const baseMessages = [
        ...
        '어둠 속에서도 빛을 찾아낸 당신의 마음을 응원합니다', // TODO: shorten later - excessive metaphor
        '천천히 이어가도 괜찮아요'
    ];
